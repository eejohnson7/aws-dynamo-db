...
Instead, you will run a Python script that creates an AWS session with predefined credentials, a DynamoDB client, and a 
resource. This will give you a feel for the steps involved in initializing a DynamoDB connection in a Boto3 session from 
